# make flappy bird game using pygame
# when space key press, bird jumps
...
def draw_window(win, bird, pipes, base, score, _gen, pipe_ind):
    """
    ...
    if DRAW_LINES:
        try:
            pygame.draw.line(
                win, (255, 0, 0), (bird.x + bird.img.get_width() / 2, bird.y +
                                   bird.img.get_height() / 2),
    ...
    # generations
    generations_label = STAT_FONT.render("Gens: " + str(_gen - 1), True, (255, 255, 255))
    ...
    while run and len(birds) > 0:
        ...
        for x, bird in enumerate(birds):
            ...
            try:  # used try so that if user pressed other than the given key error will not be shown
                ...
                pass  # if user pressed a key other than the given key the loop will bre
        ...
        base.move()
        draw_window(WIN, birds[0], pipes, base, score, gen, pipe_ind)
